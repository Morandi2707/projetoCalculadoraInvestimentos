...
export const createTable = (columnsArray, dataArray, tableId) => {
  if (
    ...
    throw new Error(
      "Para a correta execução, precisamos de um array com as coluanas, outro com a informação das linhas e também o id do elemento da tabela selecionado"
    );
  }
  const tableElement = document.getElementById(tableId);
  if (!tableElement || tableElement.nodeName !== "TABLE") {
    throw new Error("Id informado não corresponde a nenhum elemento da table");
  }
